  ...
  // ================= DASHBOARD =================
  {
    ...
    secondary: [
      ...
      },
      {
        ...
        children: [
          { name: 'Today', path: '/dashboard/overview/today', icon: ChartBarIcon, color: 'text-green-500' },
          { name: 'This Week', path: '/dashboard/overview/week', icon: ChartBarIcon, color: 'text-green-500' },
          { name: 'This Month', path: '/dashboard/overview/month', icon: ChartBarIcon, color: 'text-green-500' },
        ],
      },
      {
        name: 'Recent Activity', path: '/dashboard/activity', icon: CalendarIcon, color: 'text-yellow-500',
        children: [
          { name: 'Today', path: '/dashboard/overview/today', icon: CalendarIcon, color: 'text-yellow-500' },
          { name: 'This Week', path: '/dashboard/overview/week', icon: CalendarIcon, color: 'text-yellow-500' },
          { name: 'This Month', path: '/dashboard/overview/month', icon: CalendarIcon, color: 'text-yellow-500' },
        ],
      },
      {
        name: 'System Status', path: '/dashboard/system', icon: Cog6ToothIcon, color: 'text-red-500',
        children: [
          { name: 'Today', path: '/dashboard/overview/today', icon: Cog6ToothIcon, color: 'text-red-500' },
          { name: 'This Week', path: '/dashboard/overview/week', icon: Cog6ToothIcon, color: 'text-red-500' },
          { name: 'This Month', path: '/dashboard/overview/month', icon: Cog6ToothIcon, color: 'text-red-500' },
        ],
      },
    ],
  },
